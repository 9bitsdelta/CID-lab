...
set_property -dict { PACKAGE_PIN M20   IOSTANDARD LVCMOS33 } [get_ports { s[0] }]; #IO_L7N_T1_AD2N_35 Sch=sw[0]
set_property -dict { PACKAGE_PIN M19   IOSTANDARD LVCMOS33 } [get_ports { s[1] }]; #IO_L7P_T1_AD2P_35 Sch=sw[1]
...
set_property -dict { PACKAGE_PIN R14   IOSTANDARD LVCMOS33 } [get_ports { out }]; #IO_L6N_T0_VREF_34 Sch=led[0]
